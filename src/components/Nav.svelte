...
<div id="navbar" class="w-64 min-h-screen sm:w-full sm:min-h-0 sm:h-20 bg-[#1a1a1a]  left-0 top-0 
    ...
    <div class="w-full container mx-auto sm:flex sm:items-end sm:justify-between">
      ...
      <nav>
        <ul class="sm:flex md:text-sm justify-end ">

          <!-- <li class="px-5 md:pb-5 border-b-4 border-transparent hover:border-red-600">
            <a on:click={handleCyclo} data-target="speakers" data-offset="70" href="/wss" class="font-other text-white px-2 py-1 font-bold">Previous Speakers</a>
          </li> -->
          ...
          <li on:click={handleCyclo} data-target="partners" data-offset="70" class="px-5 md:pb-5 border-b-4 border-transparent hover:border-red-600">
            <a href="/wss" class="font-other text-white px-2 py-1 font-bold">Our Partners</a>
          </li>

          <li class="px-5 md:pb-5 border-b-4 border-transparent hover:border-red-600">
            <a on:click={handleCyclo} data-target="agenda" data-offset="70" href="/wss" class="font-other text-white px-2 py-1 font-bold">Agenda</a>
          </li>

          <li class="px-5 md:pb-5 border-b-4 border-transparent hover:border-red-600">
            <a target="_blank" href="https://forms.zohopublic.com/keralastartupmission/form/Newsletter/formperma/rGJ1ZL0uSMkQ7EYwPO16hUvD7vkTB1CMd_AaPSUk9Xw" class="font-other text-white px-2 py-1 font-bold">Sign Up for Updates</a>
          </li>
        </ul>
        
      </nav>

      <div class="md:pb-3 {scrolled ? '' : 'md:hidden'}">
